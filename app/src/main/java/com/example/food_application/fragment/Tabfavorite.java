...
public class Tabfavorite extends Fragment {
    ...
    private void recycleViewsupplier() {
        ...
        supplierList.add(new SupplierModels("1", "Kichi-Kichi Buffet Lẩu Băng Chuyền", "ic_shop_kichikichi", 4,123, "Thủ đức", 1.2, 1, 1));
        supplierList.add(new SupplierModels("2", "Dooki LẨU HÀN QUỐC TOKBOKKI BUFFET DOKKI", "ic_shop_dokkie", 5,11, "Thủ đức", 1.0, 1, 2));
        supplierList.add(new SupplierModels("3", "Hồng trà ngô gia", "ic_shop_hongtrangogia", 4, 102,"Thủ đức", 0.8, 1, 3));
        supplierList.add(new SupplierModels("4", "Lotteria", "ic_shop_lotteria", 3,78, "Thủ đức", 5.5, 10, 4));
