...
public class TinyDB {
    ...
    public ArrayList<FoodModels> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<FoodModels> playerList =  new ArrayList<FoodModels>();

        for(String jObjString : objStrings){
            FoodModels player  = gson.fromJson(jObjString,  FoodModels.class);
    ...
    public void putListObject(String key, ArrayList<FoodModels> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(FoodModels player: playerList){
