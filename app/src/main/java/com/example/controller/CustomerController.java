...
public class CustomerController {
    ...
    static{
        try {
            ...
            accountList.add(new CustomerModels("1", "admin", "admin", "phamtuyen121314@gmail.com", "0787675747", "Nguyễn Phạm Tuyên", "Nam", formatter.parse("2003-10-22"), "Phường 25 ,Quận Bình Thạnh, TP. Hồ Chí Minh", R.drawable.ic_userimage, true, 0, "randomKey1"));
            accountList.add(new CustomerModels("2", "nhatvu123","admin", "nhatvu123@gmail.com", "0909010203", "Trần Nhật Vũ", "Nữ", formatter.parse("2004-06-05"), "Thảo Điền ,TP. Thủ Đức, TP. Hồ Chí Minh", R.drawable.ic_userimage2, true, 0, "randomKey2"));
